...
class AccountUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_user" do
    assert_difference('AccountUser.count') do
      post account_users_url, params: { account_user: { account_id: @account_user.account_id, privilege: @account_user.privilege, user_id: @account_user.user_id } }
    end
  ...
  test "should update account_user" do
    patch account_user_url(@account_user), params: { account_user: { account_id: @account_user.account_id, privilege: @account_user.privilege, user_id: @account_user.user_id } }
